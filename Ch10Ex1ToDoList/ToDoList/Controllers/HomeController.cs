...
namespace ToDoList.Controllers
{
    public class HomeController : Controller
    {
        ...
        public IActionResult Index(string id)
        {
            ...
            var tasks = query.OrderBy(t => t.DueDate).ToList(); //tasks needs to be passed to model
            model.Tasks = tasks; //Error fix
            return View(model); //returns the model
        }
