...
namespace Bookstore.Controllers
{
    public class BookController : Controller
    {
        ...
        [HttpPost]
        public RedirectToActionResult PageSize(int pagesize) //Array value
        {
            var builder = new BooksGridBuilder(HttpContext.Session); //New object
            builder.CurrentRoute.PageSize = pagesize;
            builder.SaveRouteSegments(); //Filter reference
            return RedirectToAction("List", builder.CurrentRoute);
        }
